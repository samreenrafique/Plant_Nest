            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="upload/admin/<?php echo $_SESSION['adm_img'] ?>" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle " data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Carousel</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="Add Category.php" class="dropdown-item">Add Carousel</a>
                            <a href="Show Category.php" class="dropdown-item">Show Carousel</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="Show Admin.php" class="dropdown-item">Show Admin</a>
...
<nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="upload/admin/<?php echo $_SESSION['adm_img'] ?>" alt="" style="width: 40px; height: 40px;">
