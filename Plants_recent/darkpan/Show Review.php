...
include "config.php";
$query = "select user.usr_name,user.usr_email,reviews.rw_rating,reviews.rw_comments,products.pr_name from user inner join reviews ON reviews.rw_id=user.usr_id inner join products on products.pr_id=reviews.rw_id";
