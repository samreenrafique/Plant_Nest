...
<body>
    <div class="container-fluid position-relative d-flex p-0">
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="col-md-6 mt-5">
                    <div class="bg-secondary rounded h-100 p-4">
                        <h6 class="mb-4">Add Service Details</h6>
        ...
        if (isset($_POST['btn_add'])) {
            ...
            $upload_path = "upload/service/"; // Change this to your desired upload folder path
            $target_file = $upload_path . basename($sr_img);

            if (move_uploaded_file($sr_img_tmp, $target_file)) {
                // Insert into products table
                $insert = "INSERT INTO `services`(`sr_heading`, `sr_desc`, `sr_img`) 
